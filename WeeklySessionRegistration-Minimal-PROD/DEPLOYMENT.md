...
| Symptom | Fix |
|---|---|
| Import error "…not declared in the solution file as a root component" | You are importing an old zip; use `EventSessionFlows_NoTemplates_1_0_0_17.zip` from this kit |
...
| Teams card shows literal `\n` | Old flow version — re-import v1.0.0.17 |
