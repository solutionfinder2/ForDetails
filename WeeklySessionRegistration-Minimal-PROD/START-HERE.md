...
| 3 | `Flow/` | The flow solution zip (v1.0.0.15, 7 flows) + legacy per-flow packages + `MANUAL-FLOWS.md` (build-by-hand guide) |
...
│     └─ scrAdmin.yaml
├─ Flow/
│  ├─ EventSessionFlows_NoTemplates_1_0_0_15.zip   <- solution import (preferred)
